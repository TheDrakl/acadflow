    ...
    <div v-else>
      <div class="flex flex-col">
        <div class="flex justify-between">
          ...
          <div v-if="mostSold">
            <h3
              class="border-[1px] bg-milkWhite dark:bg-gray-500 dark:border-gray-600 border-yellow-300 py-1 px-2 rounded-lg shadow-md font-[300] font-inter"
            >
              Best seller
            </h3>
          </div>
        ...
        <div class="mt-2">
          <FirstButton
            class="mt-4 lg:mt-[20px] text-white dark:text-gray-100 bg-buttonColor py-[0.7rem] px-8 lg:px-8 w-full shadow-lg"
