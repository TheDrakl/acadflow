      ...
      <nav class="flex justify-between items-center h-16">
        ...
        <ul class="flex space-x-28 text-[1.1rem]">
          ...
          <li>
            ...
            <span
              class="bg-left-bottom bg-gradient-to-r from-pink-500 to-pink-500 bg-[length:0%_2px] bg-no-repeat max-w-0 group-hover:max-w-full transition-all duration-500 h-0.5 bg-yellow-300"
            ></span>
          </li>
          <a
