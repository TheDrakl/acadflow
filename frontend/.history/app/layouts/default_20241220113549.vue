    ...
    <div class="container mx-auto px-4">
      <nav class="flex justify-between items-center h-16">
        ...
        <ul class="flex space-x-28 text-[1.1rem]">
          ...
          <li><a href="#" class="group transition duration-300">CONTACT</a>
          <span class="block max-w-0 group-hover:max-w-full transition-all duration-500 h-0.5 bg-yellow-300">c</span></li>
