<template>
  <div class="bg-black text-white py-2 font-roboto font-[300]">
    <div class="container mx-auto px-4">
      <nav class="flex justify-between items-center h-16">
        ...
        <ul class="flex space-x-28 text-[1.1rem]">
          ...
          <li>
            <a href="#" class="group transition-all duration-300 ease-in-out">CONTACT</a>
            <span
              class="bg-left-bottom bg-gradient-to-r from-pink-500 to-pink-500 bg-[length:0%_2px] bg-no-repeat group-hover:bg-[length:100%_2px] transition-all duration-500 ease-out bg-yellow-300"
            ></span>
          </li>
          <a
