<template>
  <div>
    <div
      class="container mx-auto px-0 lg:px-4 lg:bg-gray-50 text-black mt-2 lg:pt-4 lg:pb-4 font-roboto font-[300] rounded-2xl bg-gradient-to-r from-transparent via-orange-50 to-transparent"
    >
