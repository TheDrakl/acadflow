...
export default {
  head: {
    titleTemplate: '%s - My Nuxt Site',
    meta: [
      { hid: 'description', name: 'description', content: 'Your site description' },
      { hid: 'keywords', name: 'keywords', content: 'nuxt, vue, seo, web development' },
      { hid: 'author', name: 'author', content: 'Your Name' },
      { hid: 'robots', name: 'robots', content: 'index, follow' },
    ],
    link: [
      { rel: 'icon', type: 'image/x-icon', href: '/favicon.ico' },
      { rel: 'canonical', href: 'https://www.yoursite.com' },
    ]
  }
}
</script>