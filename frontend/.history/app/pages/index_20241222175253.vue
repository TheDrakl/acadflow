      ...
      >
        ...
        >
          ...
          <div class="flex flex-col lg:flex-row space-x-4">
            <div>
              <FirstButton
                class="mt-[24px] text-white border-solid border-[2px] border-yellow-500 bg-buttonColor py-[0.7rem] px-30 lg:px-24"
                >Register Now</FirstButton
              >
            </div>
            <div>
              <FirstButton
                class="mt-[24px] text-white border-solid border-yellow-600 border-[2px] hover:bg-yellow-600 bg-transparent py-[0.7rem] lg:px-8"
              >
