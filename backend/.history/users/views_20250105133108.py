...
class LoginView(APIView):
    ...
    Methods:
        post(request, format=None):
            ...
            If authentication is successful and the user is active, it generates JWT tokens,
            sets the authentication cookie, sends a login success email, and returns a success response.
            If the user is not active or authentication fails, it returns an appropriate error response.
    Args:
        request (Request): The HTTP request object containing the login credentials.
