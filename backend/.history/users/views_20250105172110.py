...
class CustomTokenObtainPairView(TokenObtainPairView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        response.set_cookie(
            ...
            httponly=True,
            secure=True,
            samesite="Strict",  # You can choose 'Strict' or 'Lax' based on your requirements
            max_age=60 * 60 * 24 * 7,
        )
...
class LogoutView(APIView):
    def post(self, request):
        # Check if the 'refresh_token' cookie exists
        ...
        # Ensure that the path and domain match what was set when the cookie was created
        response.delete_cookie("refresh_token", path="/")  # Ensure to match the path
        
        # If you are using the Secure flag or HttpOnly flag, you may need to include those as well
